...
@IBDesignable
class MotionSense84BoardDemoViewController : MotionDemoViewController {
    ...
    override func setupModel() {
        ...
        motionView.setModelScene("BRD4184A_LowPoly.scn", initialOrientation: initialOrientation)
